...
__all__ = [
    'SPEI_RESERVED5', 'ISpStreamFormat', 'eLEXTYPE_PRIVATE6',
    'DISPID_SRGetRecognizers', 'SpeechRunState', 'ISpShortcut',
    'ISpeechObjectTokenCategory', 'SVP_1', 'SPCS_DISABLED',
    'STCRemoteServer', 'DISPID_SPPFirstElement', 'eLEXTYPE_PRIVATE18',
    'SpeechRecoProfileProperties', 'DISPID_SVAlertBoundary',
    'DISPID_SpeechGrammarRules', 'SREStateChange', 'ISpeechVoice',
    'DISPID_SpeechPhraseElement', 'DISPID_SRCERecognizerStateChange',
    'DISPID_SPIStartTime', 'DISPID_SRCEventInterests', 'SpFileStream',
    'ISpeechGrammarRuleState', 'DISPID_SABIMinNotification',
    'eLEXTYPE_VENDORLEXICON', 'SpeechAudioFormatType', 'SPSHT_EMAIL',
    'DISPID_SVSInputSentencePosition', 'DISPID_SpeechRecoResult2',
    'SVEPrivate', 'SpeechRuleAttributes', 'ISpObjectTokenCategory',
    'SpeechStreamFileMode', 'SVSFIsXML',
    'DISPID_SRGCmdLoadFromObject', 'SGLexicalNoSpecialChars',
    'SRAInterpreter', 'SPPS_RESERVED1', 'DISPID_SGRName',
    'eWORDTYPE_ADDED', 'DISPID_SGRInitialState',
    'DISPID_SOTDisplayUI', 'eLEXTYPE_RESERVED9',
    'DISPID_SPEPronunciation', 'SREPropertyStringChange',
    'SpeechRecognizerState', 'DISPID_SAFGuid',
    'DISPID_SRCEPhraseStart', 'SPPHRASE', 'DISPID_SLWPronunciations',
    'SPEI_RESERVED2', 'DISPID_SRGCmdLoadFromResource', 'SRATopLevel',
    'DISPID_SOTCId', 'ISpeechPhraseInfoBuilder', 'DISPID_SAStatus',
    'SpTextSelectionInformation', 'DISPID_SVRate',
    'eLEXTYPE_PRIVATE20', 'SAFT12kHz16BitStereo', 'SPXRO_SML',
    'ISpRecognizer3', 'eLEXTYPE_USER', 'SPRST_INACTIVE',
    'DISPID_SOTCEnumerateTokens', 'SPWORDTYPE', 'eLEXTYPE_PRIVATE15',
    'SpeechTokenShellFolder', 'SRTStandard', 'SREBookmark',
    'ISpLexicon', 'DISPID_SPELexicalForm', 'SAFT8kHz8BitStereo',
    'SAFT24kHz16BitMono', 'DISPID_SVSyncronousSpeakTimeout',
    'SGDSInactive', 'SpeechTokenKeyUI', 'DISPID_SMSSetData',
    'SGRSTTWord', 'IStream', 'SpNullPhoneConverter',
    'SSFMCreateForWrite', 'SPEI_REQUEST_UI',
    'DISPID_SpeechWaveFormatEx', 'SWPUnknownWordUnpronounceable',
    'SDKLDefaultLocation', 'SAFT8kHz16BitStereo',
    'DISPID_SpeechPhraseReplacements', 'SVEAllEvents',
    'DISPID_SGRs_NewEnum', 'SPSMF_SRGS_SAPIPROPERTIES', 'SPBO_NONE',
    'eLEXTYPE_PRIVATE4', 'ISpEventSource', 'DISPIDSPRG',
    'SPSFunction', 'ISpObjectWithToken', 'SAFTCCITT_uLaw_22kHzMono',
    'DISPID_SRSetPropertyNumber', 'DISPID_SPAStartElementInResult',
    'SREAdaptation', 'ISpNotifySink', 'DISPID_SpeechCustomStream',
    'DISPID_SLWType', 'DISPID_SRGSetWordSequenceData',
    'eLEXTYPE_PRIVATE17', 'SPSHORTCUTPAIR', 'DISPID_SADefaultFormat',
    'Speech_Default_Weight', 'DISPID_SGRSTNextState',
    'DISPID_SOTsCount', 'SAFTGSM610_44kHzMono',
    'DISPID_SVSLastResult', 'SPAUDIOOPTIONS', 'SPSMF_SAPI_PROPERTIES',
    'tagSTATSTG', 'DISPID_SRCERequestUI', 'SPRS_INACTIVE',
    'SAFT44kHz8BitMono', 'SAFTCCITT_uLaw_8kHzStereo', 'SGRSTTEpsilon',
    'SVEBookmark', 'SGDSActiveWithAutoPause',
    'DISPID_SRCEFalseRecognition', 'SRSActiveAlways',
    '_RemotableHandle', 'ISpeechPhraseElements', 'SGDisplay',
    'DISPID_SGRSTPropertyName', 'SpMMAudioEnum',
    'DISPID_SVAudioOutputStream', 'SAFT8kHz8BitMono', 'SRSActive',
    'DISPID_SPCIdToPhone', 'DISPID_SRSNumberOfActiveRules',
    'SpeechMicTraining', 'SpeechRetainedAudioOptions',
    'DISPID_SPRulesItem', 'SBOPause',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'IInternetSecurityMgrSite', 'DISPID_SPPValue', 'DISPID_SPPsCount',
    'SPEVENT', 'DISPID_SPEsCount', 'SpeechPropertyAdaptationOn',
    'SVP_3', 'SREAudioLevel', 'SASClosed', 'SDA_No_Trailing_Space',
    'DISPID_SRCRetainedAudioFormat', 'eLEXTYPE_PRIVATE16',
    'DISPID_SpeechGrammarRuleState', 'ISpPhraseAlt', 'SVF_Emphasis',
    'SAFTCCITT_ALaw_8kHzMono', 'DISPID_SFSClose', 'DISPID_SVSpeak',
    'DISPID_SGRAttributes', 'DISPID_SPEs_NewEnum', 'SVSFVoiceMask',
    'ISpeechRecoResult', 'SAFTText', 'DISPID_SRCResume',
    'DISPID_SOTCSetId', 'DISPID_SPEAudioSizeTime', 'SITooLoud',
    'DISPID_SMSGetData', 'ISpeechPhraseProperty', 'SVP_8',
    'SVEVoiceChange', 'SASRun', 'eLEXTYPE_PRIVATE2', 'SVP_4',
    'DISPID_SRCPause', 'DISPID_SVPriority', 'SpeechAudioVolume',
    'ISpeechGrammarRuleStateTransition', 'DISPID_SpeechObjectToken',
    'DISPID_SVGetVoices', 'SVP_2', 'SGRSTTWildcard',
    'DISPID_SVSLastBookmarkId', 'DISPID_SGRSTsCount', 'SPEI_MIN_SR',
    'DISPID_SVSCurrentStreamNumber', 'ISpRecoGrammar2',
    'eLEXTYPE_MORPHOLOGY', 'DISPID_SRAudioInput',
    'ISpeechAudioBufferInfo', 'DISPID_SpeechVoiceStatus',
    'DISPID_SLPPhoneIds', 'DISPID_SVEStreamStart', 'SPAS_RUN',
    'DISPID_SPRsItem', 'SREHypothesis', 'DISPID_SGRsAdd',
    'SpeechUserTraining', 'DISPID_SRGId', 'DISPID_SWFEBlockAlign',
    'DISPID_SABufferInfo', 'DISPID_SRRAudioFormat',
    'SpeechCategoryAudioOut', 'SITooFast', 'DISPID_SRCEEnginePrivate',
    'SRTEmulated', 'eLEXTYPE_RESERVED4', 'SPRST_NUM_STATES',
    'SP_VISEME_19', 'DISPID_SRGetPropertyNumber', 'SP_VISEME_3',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'DISPID_SVEAudioLevel',
    'SP_VISEME_0', 'SPSVerb', 'DISPID_SASState', 'SPSModifier',
    'SGRSTTRule', 'DISPID_SOTs_NewEnum', 'SPVOICESTATUS',
    'SPSHT_Unknown', 'SAFTCCITT_ALaw_22kHzMono', 'SPAUDIOBUFFERINFO',
    'SVPAlert', 'SPAR_High', 'SPPHRASEPROPERTY',
    'DISPID_SASFreeBufferSpace', 'DISPID_SWFEBitsPerSample',
    'DISPID_SRSSupportedLanguages', 'SPFM_CREATE',
    'SPSERIALIZEDRESULT', 'DISPID_SGRSTRule', 'SAFTADPCM_11kHzStereo',
    'SVP_18', 'SPAS_STOP', 'DISPID_SpeechPhraseProperty',
    'DISPID_SRRPhraseInfo', 'DISPID_SVEStreamEnd', 'SVSFNLPSpeakPunc',
    'DISPID_SDKGetBinaryValue', 'DISPID_SpeechVoiceEvent',
    'SpeechEngineProperties', 'SAFT12kHz8BitStereo',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'SPSLMA',
    'SpSharedRecognizer', 'DISPID_SRCERecognitionForOtherContext',
    'SP_VISEME_20', 'DISPID_SVVolume', 'SPGS_DISABLED',
    'DISPID_SRCESoundStart', 'SpeechLexiconType',
    'DISPID_SVIsUISupported', 'SAFT48kHz8BitMono', 'SVP_7',
    'DISPID_SPIEnginePrivateData', 'SDTRule', 'SPPHRASERULE',
    'DISPID_SGRId', 'SpeechAudioProperties', 'DISPID_SRRTimes',
    'ISpeechRecoResultDispatch', 'SpMemoryStream',
    'DISPID_SAEventHandle', 'SP_VISEME_1', 'eLEXTYPE_LETTERTOSOUND',
    'DISPID_SPIGrammarId', 'SPSInterjection', 'DISPID_SPIRule',
    'ISpeechRecoGrammar', 'SPEI_TTS_PRIVATE', 'eLEXTYPE_PRIVATE8',
    'SPPS_NotOverriden', 'SpeechGrammarTagWildcard',
    'DISPID_SpeechPhraseAlternate', 'ISpeechBaseStream',
    'SDKLCurrentConfig', 'DISPID_SpeechPhraseBuilder',
    'SPPS_Modifier', 'SPDKL_CurrentConfig',
    'DISPID_SpeechPhoneConverter', 'ISpeechLexiconWords',
    'SRERecognition', 'SAFTTrueSpeech_8kHz1BitMono',
    'DISPID_SDKDeleteValue', 'DISPID_SMSAMMHandle',
    'STCInprocHandler', 'ISpeechPhraseReplacements', 'SPCT_COMMAND',
    'SPSHORTCUTTYPE', 'SRCS_Enabled', 'ISpSerializeState',
    'SAFT16kHz16BitMono', 'DISPID_SLPsCount', 'SpResourceManager',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SAFTCCITT_uLaw_44kHzStereo', 'DISPIDSPTSI_ActiveOffset',
    'DISPID_SRCBookmark', 'eLEXTYPE_PRIVATE10', 'SpCompressedLexicon',
    'SAFT24kHz8BitStereo', 'SVSFParseSapi', 'SAFT32kHz8BitMono',
    'DISPID_SPRuleConfidence', 'SPWF_SRENGINE',
    'SDA_One_Trailing_Space', 'SpeechCategoryPhoneConverters',
    'SPEI_START_INPUT_STREAM', 'SRTExtendableParse', 'SPAR_Medium',
    'DISPID_SpeechRecoResultTimes', 'DISPID_SAFSetWaveFormatEx',
    'SAFTADPCM_44kHzMono', 'DISPIDSPTSI',
    'DISPID_SGRSAddSpecialTransition', 'SPFM_OPEN_READWRITE',
    'DISPID_SpeechPhraseInfo', 'DISPID_SGRSTType',
    'DISPID_SRSClsidEngine', 'SP_VISEME_6', 'SVEPhoneme',
    'SDTAlternates', 'SREStreamStart', 'DISPID_SGRAddResource',
    'DISPID_SpeechRecoContextEvents', 'DISPID_SBSSeek',
    '_ISpeechRecoContextEvents', 'SPPHRASEELEMENT',
    'ISpeechFileStream', 'DISPID_SpeechAudioBufferInfo',
    'DISPID_SVGetAudioOutputs', 'SWTAdded',
    'DISPID_SPIAudioStreamPosition', 'DISPID_SRIsShared',
    'DISPID_SDKEnumValues', 'SVPNormal', 'SAFT32kHz8BitStereo',
    'SDTLexicalForm', 'DISPID_SPEActualConfidence', 'SP_VISEME_10',
    'SpPhoneConverter', 'DISPID_SPPName', 'ISpeechPhraseElement',
    'SpeechGrammarState', 'SpeechAllElements', 'SPEI_VOICE_CHANGE',
    'SRCS_Disabled', 'SPDATAKEYLOCATION', 'eLEXTYPE_RESERVED10',
    'DISPID_SPAs_NewEnum', 'STSF_FlagCreate', 'ISpAudio',
    'DISPID_SpeechVoice', 'DISPID_SLRemovePronunciationByPhoneIds',
    'eLEXTYPE_PRIVATE9', 'DISPID_SpeechRecognizerStatus',
    'DISPID_SVPause', 'SPCT_SLEEP', 'ISpProperties',
    'DISPID_SPPEngineConfidence', 'SpeechAddRemoveWord',
    'DISPID_SpeechObjectTokens', 'DISPID_SPIRetainedSizeBytes',
    'SVP_6', 'SPEI_PROPERTY_STRING_CHANGE', 'SpeechTokenContext',
    'DISPID_SRCEPropertyStringChange', 'DISPID_SPEsItem',
    'ISpNotifySource', 'SpeechVoiceCategoryTTSRate', 'SPEVENTENUM',
    'DISPID_SRCEStartStream', 'DISPID_SDKSetBinaryValue',
    'DISPID_SRCERecognition', 'DISPID_SpeechAudio',
    'DISPID_SLGenerationId', 'SINoise', 'DISPID_SPRNumberOfElements',
    'SECFIgnoreKanaType', 'DISPID_SVSInputWordPosition',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SAFTADPCM_8kHzStereo',
    'SpeechPropertyComplexResponseSpeed', 'SP_VISEME_8', 'SPPS_Noun',
    'SPEI_VISEME', 'SGSExclusive', 'SPFM_OPEN_READONLY', 'ISpDataKey',
    'DISPID_SRGCmdLoadFromFile', 'SAFT11kHz16BitMono',
    'SpeechCategoryRecoProfiles', 'DISPID_SPEDisplayText',
    'SPSHORTCUTPAIRLIST', 'DISPID_SpeechBaseStream',
    'DISPID_SPPChildren', 'SpeechDataKeyLocation',
    'DISPID_SPAPhraseInfo', 'ISpeechAudio', 'SGRSTTDictation',
    'SPPARTOFSPEECH', 'SVP_10', 'DISPID_SGRsItem',
    'SAFTGSM610_22kHzMono', 'SVSFParseAutodetect', 'SRAExport',
    'SVSFParseMask', 'DISPID_SVSLastBookmark', 'SPRECOSTATE',
    'SVP_13', 'SRAONone', 'SRERequestUI', 'SAFTADPCM_22kHzStereo',
    'DISPID_SPRuleParent', 'DISPID_SPRuleChildren', 'SP_VISEME_5',
    'ISpeechRecoResult2', 'SPEI_MIN_TTS', 'DISPID_SOTCreateInstance',
    'DISPID_SOTRemoveStorageFileName', 'DISPID_SRRAlternates',
    'SVSFDefault', 'SPRECOGNIZERSTATUS', 'SVP_21',
    'DISPID_SPRFirstElement', 'DISPID_SRRRecoContext',
    '_ISpeechVoiceEvents', 'DISPID_SPERetainedSizeBytes',
    'SAFTADPCM_8kHzMono', 'SpeechVoicePriority', 'SPDKL_CurrentUser',
    'SGDSActive', 'SAFT22kHz16BitMono',
    'DISPID_SpeechLexiconPronunciation', 'DISPID_SpeechMMSysAudio',
    'DISPID_SRRSpeakAudio', 'DISPID_SGRsCommit', 'SRSEDone',
    'SLODynamic', 'SAFT11kHz16BitStereo', 'SPAR_Unknown',
    'SRADynamic', 'SPFM_CREATE_ALWAYS', 'SP_VISEME_18',
    'DISPID_SVSVisemeId', 'SpeechGrammarTagUnlimitedDictation',
    'SP_VISEME_11', 'SpeechTokenValueCLSID',
    'SpeechGrammarTagDictation', 'DISPID_SASNonBlockingIO',
    'DISPID_SRGetFormat', 'SREPhraseStart', 'SREPropertyNumChange',
    ...
    'DISPID_SpeechRecoResult', 'SPWT_LEXICAL', 'ISpEventSink',
    'ISpeechLexicon', 'Speech_Max_Word_Length', 'DISPID_SVEPhoneme',
    'ISpRecoCategory', 'DISPID_SPCPhoneToId', 'SAFT48kHz16BitStereo',
    'SRTAutopause', 'DISPID_SABIEventBias', 'DISPID_SRGRules',
    'DISPID_SPPs_NewEnum', 'SDTProperty', 'SPEI_PHONEME',
    'SpeechTokenKeyAttributes', 'SAFT16kHz8BitStereo',
    'IInternetSecurityManager', 'SVSFNLPMask', 'SPEI_TTS_AUDIO_LEVEL',
    ...
    'DISPID_SGRSTWeight', 'eLEXTYPE_RESERVED6', 'SGPronounciation',
    'DISPID_SVSpeakStream', 'SP_VISEME_13',
    'DISPID_SRGetPropertyString', 'SPADAPTATIONRELEVANCE',
    'SpeechVoiceSpeakFlags', 'SPAR_Low',
    ...
    'SpeechPropertyResourceUsage', 'DISPID_SRSCurrentStreamNumber',
    'DISPID_SVWaitUntilDone', 'SAFT11kHz8BitStereo',
    'DISPID_SPRuleFirstElement', 'DISPID_SPRuleNumberOfElements',
    'SpeechAudioState', 'DISPID_SRAudioInputStream',
    'SECFIgnoreWidth', 'SVEWordBoundary', 'DISPID_SWFEAvgBytesPerSec',
    'DISPID_SRCSetAdaptationData', 'DISPID_SMSALineId',
    'SRSInactiveWithPurge', 'SpWaveFormatEx', 'SPEI_HYPOTHESIS',
    'DISPID_SRRSetTextFeedback', 'DISPID_SRGState', 'SPSHT_OTHER',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'ISpPhoneConverter',
    'SpPhoneticAlphabetConverter', 'DISPID_SPEAudioTimeOffset',
    'SPPS_RESERVED3', 'SAFT48kHz8BitStereo',
    'SpeechTokenIdUserLexicon', 'DISPID_SGRsCommitAndSave', 'SPRULE',
    'DISPID_SDKCreateKey', 'SRARoot', 'DISPID_SGRSTsItem',
    'DISPID_SPAsCount', 'ISpeechCustomStream', 'SPGRAMMARSTATE',
    'DISPID_SPERequiredConfidence', 'DISPID_SRProfile',
    'SVESentenceBoundary', 'eLEXTYPE_PRIVATE19', 'SpVoice',
    'DISPID_SRGCmdSetRuleIdState', 'SPEI_START_SR_STREAM',
    'SAFTNoAssignedFormat', 'DISPID_SVGetAudioInputs',
    'SAFT44kHz16BitMono', 'DISPID_SPRules_NewEnum',
    'SAFT12kHz8BitMono', 'DISPID_SRCEEndStream',
    'DISPID_SGRsFindRule', 'DISPID_SFSOpen',
    'DISPID_SRCEPropertyNumberChange',
    'SPINTERFERENCE_LATENCY_WARNING', 'DISPID_SVEVoiceChange',
    'DISPID_SLWWord', 'SPSTREAMFORMATTYPE', 'SPEI_PHRASE_START',
    'SPEI_SR_AUDIO_LEVEL', 'SAFTCCITT_uLaw_44kHzMono',
    'DISPID_SpeechPhraseRules', 'SPGS_ENABLED', 'SLTUser',
    'DISPID_SpeechFileStream', 'DISPID_SOTMatchesAttributes',
    'SITooSlow', 'SPEI_END_SR_STREAM', 'SPEI_RESERVED3',
    'DISPID_SRIsUISupported', 'ISpeechAudioFormat',
    'eLEXTYPE_PRIVATE11', 'SPCONTEXTSTATE', 'SpeechEngineConfidence',
    'SVP_20', 'SPEI_RESERVED1', 'SWTDeleted', 'ISpeechPhraseRule',
    'SpeechRecoContextState', 'SpeechBookmarkOptions',
    'SPGS_EXCLUSIVE', 'ISpNotifyTranslator', 'DISPID_SRRAudio',
    'eLEXTYPE_APP', 'SP_VISEME_4', 'SpInprocRecognizer',
    'SPRST_ACTIVE', 'DISPID_SASetState', 'STSF_AppData',
    'SSSPTRelativeToEnd', 'SRAImport', 'DISPID_SVSPhonemeId',
    'DISPID_SASCurrentSeekPosition',
    'ISpeechGrammarRuleStateTransitions', 'DISPID_SABufferNotifySize',
    'SPINTERFERENCE_NOSIGNAL', 'SPSUnknown', 'DISPID_SRGCommit',
    'SDA_Consume_Leading_Spaces', 'SPAUDIOSTATE',
    'DISPID_SPEDisplayAttributes', 'SPINTERFERENCE',
    'ISpeechRecognizer', 'SPAS_PAUSE', 'DISPID_SGRsCount',
    'ISpeechDataKey', 'DISPID_SABIBufferSize',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SSTTTextBuffer',
    'eLEXTYPE_PRIVATE13', 'SpeechRegistryUserRoot', 'SPLOADOPTIONS',
    'DISPID_SPACommit', 'DISPID_SLWLangId', 'SpeechWordType',
    'SP_VISEME_16', 'SPVISEMES', 'SPEI_PROPERTY_NUM_CHANGE',
    'SPEI_MAX_SR', 'DISPID_SVResume', 'DISPID_SDKEnumKeys',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SP_VISEME_9',
    'DISPID_SVEWord', 'DISPID_SLWs_NewEnum', 'SVF_None',
    'SPCT_DICTATION', 'DISPID_SWFEExtraData', 'SP_VISEME_17',
    'SRERecoOtherContext', 'SpPhraseInfoBuilder', 'ISpRecoContext2',
    'DISPID_SRCEAdaptation', 'DISPID_SDKGetlongValue',
    'SDKLCurrentUser', 'SPEVENTSOURCEINFO', 'ISpResourceManager',
    'SpUnCompressedLexicon', 'SPGRAMMARWORDTYPE', 'SVSFUnusedFlags',
    'DISPID_SBSWrite', 'SPRS_ACTIVE_USER_DELIMITED',
    'DISPID_SRGDictationUnload', 'STCInprocServer', 'SVP_16',
    'Speech_StreamPos_RealTime', 'ISpRecoContext',
    'DISPID_SpeechXMLRecoResult', 'DISPID_SVSpeakCompleteEvent',
    'DISPIDSPTSI_ActiveLength', 'DISPID_SVSLastStreamNumberQueued',
    'SAFT24kHz16BitStereo', 'eLEXTYPE_RESERVED8', 'SECHighConfidence',
    'ISpMMSysAudio', 'SP_VISEME_12', 'DISPID_SVESentenceBoundary',
    'ISpRecognizer', 'DISPID_SLWsItem', 'DISPID_SOTSetId',
    'SRADefaultToActive', 'DISPID_SOTRemove', 'SECFIgnoreCase',
    'SVP_14', 'DISPID_SLPPartOfSpeech', 'SpCustomStream',
    'SPDKL_LocalMachine', 'DISPID_SRCRequestedUIType',
    'SPEI_SOUND_END', 'SPSNoun', 'DISPID_SVStatus',
    'DISPID_SVEBookmark', 'ISpeechAudioStatus', 'SAFT44kHz8BitStereo',
    'SpeechPropertyLowConfidenceThreshold',
    'ISpeechLexiconPronunciations', 'SPSSuppressWord', 'SPVPRI_ALERT',
    'SAFTCCITT_uLaw_8kHzMono', 'DISPID_SAVolume', 'SPEI_SOUND_START',
    'DISPID_SRRGetXMLResult', 'DISPID_SpeechAudioFormat',
    ...
    'DISPID_SPERetainedStreamOffset', 'SPLO_DYNAMIC', 'LONG_PTR',
    'SPPS_Function', 'DISPID_SLPs_NewEnum',
    ...
    'DISPID_SpeechRecoContext', 'SPRS_ACTIVE', 'SAFT8kHz16BitMono',
    'SGLexical', 'SPEI_TTS_BOOKMARK', 'SGDSActiveUserDelimited',
    'DISPID_SDKDeleteKey', 'ISpVoice', 'DISPID_SPIGetText',
    'SPBO_TIME_UNITS', 'SDTAll', 'DISPID_SPILanguageId', 'SINoSignal',
    'SVP_11', 'SpStream', 'DISPID_SWFEFormatTag', 'SpeechVisemeType',
    'DISPID_SPAsItem', 'SVSFIsNotXML', 'DISPID_SRCVoice',
    'SPAUDIOSTATUS', 'SSTTWildcard', 'SREFalseRecognition',
    'DISPIDSPTSI_SelectionLength', 'SpeechTokenKeyFiles',
    'SP_VISEME_2', 'DISPID_SRState', 'SpMMAudioIn', 'DISPID_SPPsItem',
    'DISPID_SRCAudioInInterferenceStatus', 'STCAll',
    'SAFTCCITT_ALaw_44kHzMono', 'SPEI_FALSE_RECOGNITION',
    'DISPID_SRCVoicePurgeEvent', 'SPSERIALIZEDPHRASE', 'SVF_Stressed',
    'SPINTERFERENCE_TOOQUIET', 'SpeechRecoEvents',
    'SpeechPropertyResponseSpeed', 'SAFTADPCM_44kHzStereo',
    'DISPID_SRRDiscardResultInfo', 'SECNormalConfidence',
    'SPFM_NUM_MODES', 'eLEXTYPE_PRIVATE3', 'DISPID_SOTGetDescription',
    'SECFDefault', 'DISPID_SDKGetStringValue', 'SGSEnabled',
    'SpeechGrammarWordType', 'DISPID_SPRDisplayAttributes',
    'SAFTCCITT_uLaw_11kHzMono', 'DISPID_SPARecoResult',
    'SVEAudioLevel', 'SECFNoSpecialChars', 'SGRSTTTextBuffer',
    'ISpeechPhraseRules', 'SPCATEGORYTYPE', 'ISpRecoResult',
    'WAVEFORMATEX', 'SpeechFormatType', 'SAFTExtendedAudioFormat',
    'SPBO_AHEAD', 'DISPID_SRRecognizer', 'DISPID_SRCEHypothesis',
    'eLEXTYPE_PRIVATE14', 'SPEI_SR_RETAINEDAUDIO',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'SRESoundStart',
    'SAFTCCITT_uLaw_11kHzStereo', 'DISPID_SDKOpenKey',
    'SpeechCategoryAudioIn', 'DISPID_SRRTStreamTime', 'SBONone',
    'SPEI_END_INPUT_STREAM', 'DISPID_SVAudioOutput',
    'DISPID_SPRs_NewEnum', 'SRTReSent', 'SPEI_INTERFERENCE',
    'SRSInactive', 'DISPID_SPEAudioStreamOffset',
    'DISPIDSPTSI_SelectionOffset', 'eLEXTYPE_PRIVATE12',
    'DISPID_SRCreateRecoContext', 'SITooQuiet',
    'DISPID_SPRuleEngineConfidence', 'SINone',
    'ISpeechResourceLoader', 'SpShortcut', 'SAFTDefault',
    'IEnumSpObjectTokens', 'SVP_12', 'ISpRecoGrammar',
    'SSSPTRelativeToStart', 'ISpeechRecoResultTimes',
    'DISPID_SGRSTransitions', 'SDTAudio', 'SPEI_WORD_BOUNDARY',
    'SAFTGSM610_11kHzMono', 'DISPID_SPRulesCount', 'DISPID_SLPsItem',
    'ISpeechXMLRecoResult', 'DISPID_SRCCreateResultFromMemory',
    'DISPID_SLAddPronunciation', 'ISpeechPhraseProperties',
    'SpeechVisemeFeature', 'DISPID_SRRSaveToMemory',
    'SAFT16kHz16BitStereo', 'ISequentialStream',
    'DISPID_SPEEngineConfidence', 'SPPS_Interjection',
    'STCLocalServer', 'Speech_Max_Pron_Length',
    'DISPID_SAFGetWaveFormatEx', 'SPWORD', 'eWORDTYPE_DELETED',
    'DISPID_SpeechRecognizer', 'DISPID_SGRSRule',
    'eLEXTYPE_RESERVED7', 'SRESoundEnd', 'DISPID_SPPConfidence',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SPWT_DISPLAY',
    'SDA_Two_Trailing_Spaces', 'DISPID_SOTId', 'SpNotifyTranslator',
    'DISPID_SRRTTickCount', 'DISPID_SBSRead',
    'SSSPTRelativeToCurrentPosition', 'SLTApp',
    'DISPID_SVSInputSentenceLength', 'SPSEMANTICFORMAT',
    'SPWT_PRONUNCIATION', 'DISPID_SVVoice', 'ISpeechGrammarRules',
    'SPEI_SENTENCE_BOUNDARY', 'SPAS_CLOSED', 'ISpeechPhraseInfo',
    'DISPID_SGRClear', 'SPCT_SUB_DICTATION', 'SDTDisplayText',
    'SFTSREngine', 'DISPID_SRGCmdSetRuleState', 'DISPID_SRCESoundEnd',
    'DISPID_SpeechPhraseAlternates', 'SAFTCCITT_ALaw_44kHzStereo',
    'SAFT22kHz8BitMono', 'SpLexicon',
    'DISPID_SpeechObjectTokenCategory', 'DISPID_SPIElements',
    'SPSNotOverriden', 'SPPS_RESERVED4', 'SpeechPartOfSpeech',
    'SVP_19', 'ISpRecognizer2', 'DISPID_SPRuleId',
    'DISPID_SWFESamplesPerSec', 'SPINTERFERENCE_TOOSLOW',
    'SPBO_PAUSE', 'DISPID_SPRText', 'SpAudioFormat',
    'DISPID_SRRGetXMLErrorInfo', 'ISpeechPhraseAlternates',
    'SAFTCCITT_ALaw_11kHzStereo', 'DISPID_SRCCreateGrammar',
    'DISPID_SRRTOffsetFromStart', 'SPWF_INPUT', 'ISpeechObjectToken',
    'ISpGrammarBuilder', 'SPEI_MAX_TTS', 'SpSharedRecoContext',
    'DISPID_SpeechAudioStatus', 'SPWORDPRONUNCIATION', 'SVP_15',
    'tagSPPROPERTYINFO', 'SECFEmulateResult', 'ISpeechPhoneConverter',
    'SVP_17', 'SPPS_RESERVED2', 'SPEI_RECOGNITION',
    'eLEXTYPE_PRIVATE7', 'DISPID_SREmulateRecognition',
    'DISPID_SRCRetainedAudio', 'DISPID_SLRemovePronunciation',
    'SPVPRI_NORMAL', 'SVEStartInputStream', 'SpeechCategoryVoices',
    'SLOStatic', 'DISPID_SRGRecoContext', 'DISPID_SGRSTs_NewEnum',
    'DISPID_SVGetProfiles', 'SPRECOCONTEXTSTATUS', 'DISPID_SRGReset',
    'ISpeechTextSelectionInformation', 'DISPID_SLGetWords',
    'SSFMOpenForRead', 'SSFMOpenReadWrite', 'DISPID_SPPParent',
    'SpeechEmulationCompareFlags', 'SPEI_UNDEFINED',
    'DISPID_SRCState', 'SPRST_ACTIVE_ALWAYS', 'SPEI_RESERVED6',
    'DISPID_SOTCDefault', 'SAFTCCITT_ALaw_11kHzMono',
    'SAFTCCITT_ALaw_8kHzStereo', 'DISPID_SVEEnginePrivate',
    'SpeechRuleState', 'DISPID_SLGetGenerationChange',
    'ISpeechObjectTokens', 'DISPID_SPPId', 'DISPID_SVEViseme',
    'DISPID_SRStatus', 'DISPID_SRDisplayUI', 'SPEI_SR_BOOKMARK',
    'SAFT24kHz8BitMono', 'SpeechLoadOption', 'SAFT48kHz16BitMono',
    'DISPID_SRCEInterference', 'DISPID_SBSFormat',
    'ISpeechLexiconWord', 'SVEViseme', 'ISpeechWaveFormatEx',
    'SPPS_LMA', 'SpeechSpecialTransitionType', 'STSF_CommonAppData',
    'SRAORetainAudio', 'DISPID_SGRSAddRuleTransition',
    'SpeechAudioFormatGUIDText', 'SREStreamEnd', 'DISPID_SOTDataKey',
    'ISpeechRecoContext', 'SPINTERFERENCE_TOOFAST',
    'DISPID_SCSBaseStream', 'SPWORDPRONUNCIATIONLIST',
    'SPEI_SR_PRIVATE', 'DISPID_SPIEngineId',
    'DISPID_SPPNumberOfElements', 'DISPID_SGRsDynamic',
    'ISpeechPhraseReplacement', 'SP_VISEME_14', 'SVSFPersistXML',
    ...
    'DISPID_SGRAddState', 'DISPID_SpeechGrammarRuleStateTransition',
    'SpeechDisplayAttributes', 'SVEEndInputStream',
    'eLEXTYPE_USER_SHORTCUT', 'SPFILEMODE', 'SAFTADPCM_22kHzMono',
    'DISPID_SpeechLexiconWord', '_SPAUDIOSTATE', 'SSFMCreate',
    'ISpPhoneticAlphabetSelection',
    'SpeechGrammarRuleStateTransitionType', 'DISPID_SRCEAudioLevel',
    ...
    'STSF_LocalAppData', 'DISPID_SPIReplacements', 'SREInterference',
    'SDTReplacement', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'SPSHT_NotOverriden', 'SAFT12kHz16BitMono', 'SpeechVoiceEvents',
    'SAFT32kHz16BitStereo', 'SPINTERFERENCE_TOOLOUD', 'UINT_PTR',
    'SVP_0', 'SPPHRASEREPLACEMENT', 'SP_VISEME_21', 'SFTInput',
    'DISPID_SRRTLength', 'ISpeechVoiceStatus', 'DISPID_SPCLangId',
    'SPPS_Verb', 'SPPROPERTYINFO', 'SPCS_ENABLED',
    ...
    'SpeechRegistryLocalMachineRoot', 'SpeechDiscardType',
    'SpStreamFormatConverter', 'SP_VISEME_7', 'SPRECORESULTTIMES',
    'DISPID_SRGDictationLoad', 'DISPID_SLPLangId',
    'DISPID_SVSInputWordLength', 'SVPOver', 'Speech_StreamPos_Asap',
    'DISPID_SPPBRestorePhraseFromMemory', 'SRTSMLTimeout',
    'DISPID_SVSRunningState', 'SDKLLocalMachine', 'SPAO_RETAIN_AUDIO',
    'SGSDisabled', 'ISpPhoneticAlphabetConverter', 'SVSFlagsAsync',
    'SPVPRIORITY', 'SAFT44kHz16BitStereo', 'DISPID_SpeechLexicon',
    'SPBOOKMARKOPTIONS', 'SPPS_Noncontent', 'DISPID_SWFEChannels',
    'DISPID_SLPSymbolic', 'SPWORDPRONOUNCEABLE',
    'DISPID_SPANumberOfElementsInResult', 'SPEI_RECO_STATE_CHANGE',
    'DISPID_SPIProperties', 'DISPID_SAFType', 'SPBINARYGRAMMAR',
    'SWPKnownWordPronounceable', 'ISpeechPhraseAlternate',
    'SPXRO_Alternates_SML', 'DISPID_SGRSTText', 'DISPID_SVDisplayUI',
    'DISPID_SLWsCount', '__MIDL_IWinTypes_0009', 'SpObjectToken',
    'DISPID_SpeechPhraseRule', 'DISPID_SPRuleName', 'SASStop',
    'SPSEMANTICERRORINFO', 'SpObjectTokenCategory',
    'DISPID_SGRSTPropertyId', 'SPAO_NONE', 'SPINTERFERENCE_NOISE',
    'SpMMAudioOut', 'DISPID_SRGCmdLoadFromMemory', 'SP_VISEME_15',
    'SpeechInterference', 'SVP_9', 'DISPID_SOTGetAttribute',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'DISPID_SRGSetTextSelection', 'DISPID_SGRSTPropertyValue',
    'SPRST_INACTIVE_WITH_PURGE', 'SAFTGSM610_8kHzMono',
    'DISPID_SPIAudioSizeTime', 'DISPID_SDKSetLongValue',
    'SpeechPropertyHighConfidenceThreshold', 'ISpeechGrammarRule',
    'SASPause', 'SPVPRI_OVER', 'ISpStream', 'SAFTADPCM_11kHzMono',
    'SPXMLRESULTOPTIONS', 'DISPID_SRSetPropertyString', 'SPLO_STATIC',
    'SVSFParseSsml', 'DISPID_SpeechLexiconWords',
    'DISPID_SGRSAddWordTransition', 'SECLowConfidence', 'SPWORDLIST',
    'SVP_5', 'DISPID_SpeechPhraseProperties', 'SPINTERFERENCE_NONE',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SAFT22kHz8BitStereo',
    'DISPID_SOTIsUISupported', 'DISPID_SVEventInterests',
    'DISPID_SOTCategory', 'ISpPhrase', 'DISPID_SRCEBookmark',
    'SAFT16kHz8BitMono', 'DISPID_SLPType', 'SAFT22kHz16BitStereo',
    'SpeechWordPronounceable', 'SPWAVEFORMATTYPE', 'SPRULESTATE',
    'ISpeechMMSysAudio', 'SREAllEvents', 'SPEI_ADAPTATION',
    'SpInProcRecoContext', 'SpeechCategoryAppLexicons',
    'DISPID_SRGIsPronounceable', 'SPEI_RECO_OTHER_CONTEXT',
    'SpeechAudioFormatGUIDWave', 'SVSFPurgeBeforeSpeak',
    'DISPID_SpeechPhraseElements', 'ISpObjectToken'
]
